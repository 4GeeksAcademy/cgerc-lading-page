...
const Home = () => {
  return (
    <>
      <Navbar title={"INICIO"} />
      <Jumbotron title={"ASESORIAS E INVERSIONES CHACON"} />
      <div class="row ">
        <div class="col ">
        ...
        <div class="col">
          <Card title={"Traslado de materiales"} imageUrl={"https://www.16valvulas.com.ar/wp-content/uploads/2017/05/nuevo-kia-k2500.jpg"} description={" Este servicio abarca desde la planificación logística y la selección del transporte adecuado (camiones, etc.), hasta la carga, descarga, embalaje y protección de los materiales. También incluye la gestión de la documentación necesaria y, a menudo, el seguimiento en tiempo real de la carga, todo con el fin de asegurar que los materiales lleguen de forma segura, eficiente y optimizando los costos."} />
